...
import addButton from "../../assets/images/contact/add_circle.jpg";
import stetoscope from "../../assets/images/contact/stethoscope.jpg";
...
export function Contact(): JSX.Element {
  ...
  return (
    <div className="contactContainer">
      ...
      <div onClick={() => navigate("/addTherapy")} className="boxBounding">
